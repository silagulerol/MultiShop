...
namespace MultiShop.Basket.LoginServices
{
    ...
    {
        /*
         HttpContext içinde request bilgileri vardır:
        Headers, Token, User, Claims, Cookies
        Ama normal class içinde HttpContext'e direkt erişemezsin.
        O yüzden ASP.NET şunu verir: IHttpContextAccessor
        ...
        HttpContext.User : Bu ClaimsPrincipal. JWT doğrulandıktan sonra ASP.NET token'ı claims olarak buraya koyar.
