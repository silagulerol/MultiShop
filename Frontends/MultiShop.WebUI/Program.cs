...
//Token �retimini ve kontrol�n� yapacak olan i�leyiciyi (handler) sisteme tan�t�yoruz:
builder.Services.AddScoped<ResourceOwnerPasswordTokenHandler>();
builder.Services.AddScoped<ClientCredentialTokenHandler>();

builder.Services.AddHttpClient<IClientCredentialTokenService, ClientCredentialTokenService>();

//appsettings.json i�indeki servis adreslerini i�eren s�n�f� (ServiceApiSettings) �ekiyoruz:
var values = builder.Configuration.GetSection("ServiceApiSettings").Get<ServiceApiSettings>();
//User Service �a��r�ld���nda hem Base Address'in otomatik set edilmesi hem de her iste�e token eklenmesi i�in Handler'�n ba�lanmas�:
...
builder.Services.AddHttpClient<IProductVariantService, ProductVariantService>(opt =>
{
    opt.BaseAddress = new Uri($"{values.OcelotUrl}/{values.Catalog.Path}");
}).AddHttpMessageHandler<ClientCredentialTokenHandler>();
